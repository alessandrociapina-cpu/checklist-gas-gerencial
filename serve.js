/**
 * Servidor HTTP local para o app Gas Gerencial.
 * Não precisa de dependências externas — só Node.js.
...
const server = http.createServer((req, res) => {
  ...
  // Segurança: não sair do diretório dist
  ...
  if (!fs.existsSync(filePath) || fs.statSync(filePath).isDirectory()) {
    // SPA fallback — todas as rotas entregam index.html
