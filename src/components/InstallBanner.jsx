  ...
  if (needRefresh) {
    return (
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[min(22rem,calc(100vw-2rem))]
        ...
        <svg className="w-5 h-5 flex-shrink-0 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button onClick={onDismiss} className="text-blue-300 hover:text-white text-xs">✕</button>
      </div>
    )
  }
